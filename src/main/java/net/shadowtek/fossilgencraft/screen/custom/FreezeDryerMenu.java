...
public class FreezeDryerMenu extends AbstractContainerMenu {
        public final FreezeDryerBlockEntity blockEntity;
        private final Level level;
        private final ContainerData data;

        public FreezeDryerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
            this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
        }

        public FreezeDryerMenu(int pContainerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
            super(ModMenuTypes.FREEZEDRYER_MENU.get(), pContainerId);
            this.blockEntity = (FreezeDryerBlockEntity) blockEntity;
        ...
        public boolean stillValid(Player pPlayer) {
            return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                    pPlayer, ModBlocks.FREEZEDRYER.get());
        }
