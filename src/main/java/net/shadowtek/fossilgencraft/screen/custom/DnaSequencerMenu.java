...
public class DnaSequencerMenu extends AbstractContainerMenu {
    ...
    public DnaSequencerMenu(int pContainerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.DNA_SEQUENCER_MENU.get(), pContainerId);
        this.blockEntity = (DnaSequencerBlockEntity) blockEntity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.DNA_SEQUENCER.get());
    }
